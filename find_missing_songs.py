...
def main():
    ...
    print "Total number of songs missing in 90s: %s/%s" %(len(missed_hits_90s), len(billboard_data_90))
    print "Total number of songs missing in 20s: %s/%s" %(len(missed_hits_20s), len(billboard_data_20))

    print "Total number of songs with missing artists in 90s: %s/%s" %(len(missing_artists_90s), len(billboard_data_90))
    print "Total number of songs with missing artists in 20s: %s/%s" %(len(missing_artists_20s), len(billboard_data_20))
